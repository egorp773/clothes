-- Signed uploads are prepared by an authenticated Edge command and written
-- with a short-lived Storage token. The token is service-generated, so this
-- narrow service-only command attaches the verified user as object owner.
